...
import com.example.spirillumin.BuildConfig;
...
public class LogInstance {
    ...
    private void initDefaultLogger() {
        ...
        Appender fileAppender = new DefaultAppenderConfigurator(logsDir, "base.roll",null, true, pid).configure(new RollingFileAppender<ILoggingEvent>());
